...
# Cron job 내용
CRON_JOB="0 0 * * * cd \"$PROJECT_DIR\" && /usr/bin/time -l \"$PYTHON_PATH\" \"$RUN_SCRIPT\" >> \"$PROJECT_DIR/logs/cron.log\" 2>&1"
...
echo "  • 30일 도달 시 자동 학습/평가 실행"
echo "  • 누적 데이터 기준 자동 재학습 + 결과물 생성"
echo "  • 자동화/릴리즈 리포트 자동 생성"
