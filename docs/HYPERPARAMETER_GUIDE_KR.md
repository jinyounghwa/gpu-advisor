...
| f-net 사전 확률 | 0.15 | 데이터 분포 기반 정규화 |
| ActionModel 사전 확률 | 0.15 | 학습된 행동 사전 확률 (utility_bias 대체) |
...
- `min_entropy_target = 0.65`: 5개 행동 최대 엔트로피 ln(5)≈1.609의 ~40% 수준
