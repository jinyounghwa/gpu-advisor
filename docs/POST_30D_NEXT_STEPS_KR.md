...
**현재 상태 (2026-04-08):**
- dataset: **47일** 누적 (2026-02-21 ~ 2026-04-08)
- 방향정확도: **0.891** / 평균 보상: +0.00172 (양수)
- 게이트: **6/7 (BLOCKED — abstain 93.38% > 93%)**
- 최초 릴리즈 태그: `release-agent-20260322-105138` (2026-03-22)
- 마지막 학습: 2026-04-03 (MCTS 60%, 엔트로피 0.45, 2000 스텝)
- 다음 자동 재학습: 2026-04-10 예정 (7일 간격, 5/7일 누적)
...
### 시나리오 A: 아직 30일 미만 (완료됨 — 2026-03-22 기준 30일 달성, 현재 47일)
...
| 게이트 | 의미 | 2026-03-22 | **2026-04-08** |
|--------|------|-----------|--------------|
| accuracy_raw | 방향정확도 > 0.55 | ✅ 0.894 | ✅ **0.891** |
| reward_raw | 평균 보상 > 0 | ✅ +0.0064 | ✅ **+0.00172** |
| abstain | 관망비율 ≤ 0.93 | ✅ 0.788 | ❌ **0.934** (0.38% 초과) |
| safe_override | 안전오버라이드 ≤ 0.90 | ✅ | ✅ |
| action_entropy_raw | 엔트로피 ≥ 0.25 | ✅ 1.459 | ✅ |
