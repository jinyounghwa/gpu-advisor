...
- 게이트: 7개 중 6개 통과 (uplift 미통과)
- 예상 30일 도달: ~2026-03-22
...
| 게이트 | 의미 | 현재 상태 |
|--------|------|-----------|
| accuracy_raw | 방향정확도 > 0.55 | ✓ 0.630 |
| reward_raw | 평균 보상 > 0 | ✓ +0.000276 |
| abstain | 관망비율 < 0.85 | ✓ 0.659 |
| safe_override | 안전오버라이드 정상 | ✓ |
| action_entropy_raw | 엔트로피 정상 | ✓ |
| no_mode_collapse_raw | 모드 붕괴 없음 | ✓ |
| uplift_raw_vs_buy | always-buy 대비 초과수익 | ✗ (30일 후 재판정) |
